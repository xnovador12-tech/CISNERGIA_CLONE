                    ...
                    <div class="">
                        ...
                        <li class="mx-2 my-1">
                            <a href="{{ route('admin-configuraciones.index') }}"
                                class="nav-link px-3 menu {{ request()->is(['admin-configuraciones*', 'admin-usuarios*', 'admin-empresa*', 'admin-perfil*', 'admin-categorias*', 'admin-etiquetas*', 'admin-clientes*', 'admin-equipo*']) ? 'active-item' : null }}">
                                <span class="fw-bold">
                        ...
                        <li class="mx-2 my-1">
                            <a href="{{-- route('admin-reservas.index') --}}"
                                class="nav-link px-3 {{ request()->is(['admin-reservas*']) ? 'active-item' : null }} menu">
                                <span class="fw-bold">
                                    <i class="bi bi-calendar-check me-2"></i>
                                </span>
                                <span>
