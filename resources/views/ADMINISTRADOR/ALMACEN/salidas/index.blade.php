            ...
            <div class="card-header bg-transparent">
                <div class="row justify-content-beetween">
                    ...
                    <div class="col-12 col-md-5 col-lg-4 col-xl-4 mb-lg-0 order-3 order-md-3 d-flex justify-content-center">
                        <form method="POST" action="{{ route('salida_general.index') }}" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate>
					    @csrf
                    ...
                    <tbody>
                        ...
                        @foreach ($admin_salidas as $admin_salida)
                            <tr>
                                ...
                                <td class="fw-normal align-middle">{{ $admin_salida->codigo }}</td>
                                ...
                                <td class="fw-normal align-middle text-end">{{ number_format($admin_salida->total, 2, '.', ',') }}</td> 
                                <td class="align-middle">                                        
                                    <div class="dropstart">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow"> 
                                            <li class="dropdown-item">
                                                <a target="_blank" href="{{ route('detalle_salida.pdf', $admin_salida->slug) }}" class="link-dark text-decoration-none"><i class="bi bi-printer-fill text-secondary me-2"></i>Imprimir</a>
                                            </li>
                                            <li class="dropdown-item">
...
{{-- Fin contenido --}}
@include('ADMINISTRADOR.ALMACEN.salidas.reporte_modal_pdf')
@endsection
