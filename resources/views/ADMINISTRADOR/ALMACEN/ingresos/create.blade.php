...
$(document).ready(function() {
            ...
            $.each(productos, function(index, value){
                ...
                if (producto != "") {
                    if(valormotivo == 'Inventario'){
                        ...
                        }if(value[2] == 'Producto Terminado'){
                            tipo_b = 'Producto Terminado';
    ...
    $('#ingresoa_id').on('change', function(){
        ...
        function eliminardtc(indexmp, cantidad,protipo_id) {
            ...
            }if(protipo_id == 'Producto Terminado'){
            ...
            cantidad_totalg=cantidad_totalma+cantidad_totalac+cantidad_totalal;
