    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin-ingresos.resultadosEXCEL') }}" method="POST">
                @csrf      
                    <div class="my-3" id="">
                    ...
                    <div class="my-3" id="">
                        ...
                        <input type="date" id="start-date"  name="fecha_ini" class="form-control form-control-sm" required>
                    </div>
                    <div class="my-3" id="">
                        <label for="">Filtrar hasta</label>
                        <input type="date" id="end-date"   name="fecha_fin" class="form-control form-control-sm" required>
                    </div>
