<div class="modal fade" id="showrepuestos{{$repuestos->id_producto}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @php
                    $producto_tipo = \App\Models\Producto::where('id',$repuestos->id_producto)->first();
                @endphp
                <div class="row">
                    ...
                    <div class="col-12 col-md-8 col-lg-10 d-flex">
                        <div class="align-self-center">
                            <p class="text-uppercase small mb-0">{{$repuestos->producto}} - {{$repuestos->umedida}}</p>
                            ...
                            <p class="float-start text-uppercase small">Stock: <span class="float-end badge bg-primary ms-2">{{$alm_repuestos_sum->cantidad}}</span></p>
                        </div>
                    </div>
                </div>
