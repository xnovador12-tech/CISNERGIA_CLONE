<div class="modal fade" id="showrepuesto{{$al_repuesto->id_producto}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-8 col-lg-10 d-flex">
                        <div class="align-self-center">
                            <p class="text-uppercase small mb-0">{{$al_repuesto->producto}} - {{$al_repuesto->umedida}}</p>
                            ...
                            <p class="float-start text-uppercase small">Stock: <span class="float-end badge bg-primary ms-2">{{$al_repuesto->cantidad}}</span></p>
                        </div>
                    </div>
                </div>
