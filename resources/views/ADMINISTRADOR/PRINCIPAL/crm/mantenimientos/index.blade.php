                                        ...
                                        <div class="dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end shadow">
                                                ...
                                                @if($mantenimiento->estado === 'programado')
                                                    ...
                                                    <li><form action="{{ route('admin.crm.mantenimientos.confirmar', $mantenimiento) }}" method="POST">@csrf<button class="dropdown-item text-primary"><i class="bi bi-check me-2"></i>Confirmar</button></form></li>
                                                @endif
                                                @if(in_array($mantenimiento->estado, ['confirmado', 'en_camino']))
                                                    <li><form action="{{ route('admin.crm.mantenimientos.iniciar', $mantenimiento) }}" method="POST">@csrf<button class="dropdown-item text-warning"><i class="bi bi-play-circle me-2"></i>Iniciar</button></form></li>
                                                @endif
