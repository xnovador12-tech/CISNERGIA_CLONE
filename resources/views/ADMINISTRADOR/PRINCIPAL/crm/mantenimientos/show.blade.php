                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            @if($mantenimiento->estado === 'programado')
                                <form action="{{ route('admin.crm.mantenimientos.confirmar', $mantenimiento) }}" method="POST">
                                    @csrf
                            ...
                            @if(in_array($mantenimiento->estado, ['confirmado', 'en_camino']))
                                <form action="{{ route('admin.crm.mantenimientos.iniciar', $mantenimiento) }}" method="POST">
                                    @csrf
...
@section('js')
<script>
// Confirmación SweetAlert ya no necesaria, usamos modales
</script>
@endsection
