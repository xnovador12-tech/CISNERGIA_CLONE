<form method="POST" action="{{ route('admin-modelos.update', $admin_modelo->slug) }}" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate>      
    @csrf  
    @method('put')  
    <div class="modal fade" id="editmodelos{{ $admin_modelo->slug }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name_id" class="form-control" value="{{ $admin_modelo->nombre }}"  maxLength="100" required>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <select name="estado" id="estado_id" class="form-select text-uppercase" required>
                                    <option value="{{ $admin_modelo->estado }}" selected="selected" hidden="hidden">{{ $admin_modelo->estado }}</option>
