    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                <div class="card border-4 borde-top-secondary box-shadow h-100" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                    <div class="card-header bg-transparent">
                        <span class="text-uppercase text-secondary fw-bold">Servicios</span>
                    </div>
                    <div class="card-body pb-0">
                        <p class="fw-normal" align="justify">Configura la informacion de los distintos servicios ofrecidos.</p>
                        <ul class="list-unstyled">
                            <li class="text-primary menu_item">
