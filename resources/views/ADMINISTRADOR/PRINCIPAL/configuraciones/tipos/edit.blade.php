<form method="POST" action="{{ route('admin-tipos.update', $admin_tipo->slug) }}" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate>      
    @csrf  
    @method('put')  
    <div class="modal fade" id="edittipos{{ $admin_tipo->slug }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name_id" class="form-control" value="{{ $admin_tipo->name }}"  maxLength="100" required>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <select name="estado" id="estado_id" class="form-select text-uppercase" required>
                                    <option value="{{ $admin_tipo->estado }}" selected="selected" hidden="hidden">{{ $admin_tipo->estado }}</option>
