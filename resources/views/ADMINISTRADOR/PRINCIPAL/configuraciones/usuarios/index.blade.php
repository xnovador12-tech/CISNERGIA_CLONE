        ...
        <div class="card border-4 borde-top-secondary shadow-sm h-100" style="border-radius: 20px; min-height: 500px" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
            <div class="card-header bg-transparent">
                <div class="row justify-content-between">
                    <div class="col-9 col-md-3 col-xl-3">
                        <button type="button" data-bs-toggle="modal" data-bs-target="#createusuarios" class="btn btn-primary text-uppercase text-white btn-sm w-100">
            ...
            <div class="card-body">
                <div class="mb-2 col-12 col-md-6">
                    <span class="text-uppercase">Total de registros encontrados: <span class="fw-bold">{{ $admin_usuarios->count() }}</span></span>
                </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($admin_usuarios as $admin_usuario)
                            <tr>
                                ...
                                <td class="fw-normal text-center align-middle">{{ $admin_usuario->name }}</td>
                                <td class="fw-normal text-center align-middle">
                                    <form method="POST" action="/admin-usuarios/estado/{{$admin_usuario->slug}}" class="form-update">
                                    @csrf
                                    @method('PUT')
                                ...
                                <td class="text-center align-middle">                                        
                                    <div class="dropstart">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow">                                                
                                            <li>
                                                <button class="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#editusuarios{{ $admin_usuario->slug }}"><i class="bi bi-pencil text-secondary me-2"></i>Editar</button>
                                            </li>
                                            <li><hr class="dropdown-divider"></li>
                                            <li>
                                                <form method="POST" action="{{ route('admin-usuarios.destroy',$admin_usuario->slug) }}" class="form-delete">
                                                    @csrf
                                                    @method('DELETE')
