    ...
    <div class="col-12 col-lg-8">
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
            <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <span class="badge bg-light border rounded-pill px-3 py-2" id="fb-count" style="color: #6c757d;">
                    Mostrando {{ count($fbData['recent_posts'] ?? []) }} posts
                </span>
            </div>
                    ...
                    <tbody id="fbFeedBody">
                        ...
                        <tr>
                            ...
                            <td class="text-center pe-4">
                                ...
                                @endphp
                                <button class="btn btn-sm rounded-pill fw-bold shadow-sm px-3 py-1 {{ $btnPostStyle['class'] }}" style="{{ $btnPostStyle['style'] }}" data-post="{{ $postPayload }}" data-plataforma="fb">
                                    <i class="bi bi-chat-text-fill"></i> <span>{{ $cCount }}</span>
                                </button>
