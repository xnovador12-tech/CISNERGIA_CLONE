...
@section('title', 'ORDEN DE SERVICIOS')
        ...
        <div class="card border-4 borde-top-secondary shadow-sm h-100" style="border-radius: 20px; min-height: 500px" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
            <div class="card-header bg-transparent">
                <div class="row justify-content-beetween">
                    <div class="col-md-3 d-flex">
                        <a type="button" href="{{ url('admin-ordenservicios/create') }}" class="btn btn-dark text-uppercase text-white btn-sm w-100">
            ...
            <div class="card-body">
                <div class="mb-2 col-12 col-md-6">
                    <span class="text-uppercase">Total de registros encontrados: <span class="fw-bold">{{ $admin_ordenservicios->count() }}</span></span>
                </div>
                <table id="display" class="table table-hover table-sm text-center" cellspacing="0" style="width:100%">
                    ...
                    <tbody>
                        @php
                            $contador = 1;
                        @endphp
                        @foreach($admin_ordenservicios as $admin_ordenservicio)
                            <tr>
                                ...
                                <td class="fw-normal align-middle">
                                    <form method="POST" action="/admin-servicios/estado/{{$admin_ordenservicio->slug}}" class="form-update">
                                    @csrf
                                    @method('PUT')
                                ...
                                <td class="align-middle">                                        
                                    <div class="dropstart">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow">
                                            ...
                                            <li>
                                                <form method="POST" action="{{ route('admin-servicios.destroy',$admin_ordenservicio->slug) }}" class="form-delete">
                                                    @csrf
                                                    @method('DELETE')
