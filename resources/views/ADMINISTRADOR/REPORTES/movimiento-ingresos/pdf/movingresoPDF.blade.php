...
<head>
    ...
    <title>CISNERGIA | REPORTE DE MOVIMIENTOS DE INGRESO - PDF</title>
        ...
        <table class="hdr-table">
            <tr>
                ...
                <td class="hdr-td-text">
                    ...
                    <span class="hdr-title">Reporte de <span class="hdr-title-accent">Ingresos</span></span>
                    <span class="hdr-date">
                    ...
                    <tr class="{{ $contador % 2 == 0 ? 'fila-par' : '' }}">
                        ...
                        <td>
                            ...
                            @elseif($item->motivo == 'TRASLADO')
                                <span class="origen-prefix">CS:</span>{{ $item->codigo_msalida }}
                            @else
            ...
            <table class="footer-tbl">
                <tr>
                    <td class="footer-td-left">
                        ...
                        <span class="footer-sub">Reporte de Movimientos de Ingreso</span>
                    </td>
