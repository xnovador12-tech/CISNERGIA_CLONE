                ...
                <td style="width: 85%">
                    ...
                    <table class="w-100 mt-1">
                        <td style="width: 100%" class="">
                            <p class="text-start text-uppercase mt-2 small texto-11">Total de movimientos de ingreso encontrados: <span class="badge bg-primary">{{$ingresos->count()}}</span></p>
                        </td>
                    </table>
                </td>
            </table>
    ...
    <div class="contenido">
        ...
        @else
            <div class="alert alert-light">
                <small class="fst-italic">*Se muestra la lista de movimientos de ingresos registradas de la : {{ $name_sucursal->name }} </small>
        ...
        <table class="w-100 mt-2" style="font-size: 10px;">
            <thead class="">
                <tr>
                    ...
                    <th class="border-0 border-bottom border-dark py-1 text-uppercase text-center">Codigo de origen</th>
                ...
                <tbody>
                    ...
                    @foreach($ingresos as $item)
                        <tr>
                            ...
                            <td class="border-bottom py-1 border-dark text-center"><span class="badge bg-secondary">{{ $item->codigo }}</span></td>
                            <td class="border-bottom py-1 border-dark text-center">{{ $item->created_at->format('d-m-Y H:i:s')}}</td>
                            <td class="border-bottom py-1 border-dark text-center text-uppercase">{{ $item->motivo }}</td>
