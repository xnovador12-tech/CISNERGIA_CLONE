        ...
        <table class="hdr-table">
            <tr>
                ...
                <td class="hdr-td-text">
                    ...
                    <span class="hdr-title">Movimiento de <span class="hdr-title-accent">Ingreso</span></span><br>
                    <span class="hdr-badge">{{ $admin_ingreso->codigo }}</span>
                    <span class="hdr-date">
    ...
    <div class="contenido">
                ...
                <tr>
                    ...
                    <td style="width:17%">
                        ...
                        <div class="ic-body ic-body-sky">
                            <span class="ic-val">{{ $admin_ingreso->codigo }}</span>
                        </div>
                    </td>
                    ...
                    <td style="width:15%">
                        ...
                        <div class="ic-body ic-body-solar">
                            <span class="pill">{{ $admin_ingreso->motivo }}</span>
                        </div>
                    </td>
                    ...
                    <td style="width:16%">
                        ...
                        <div class="ic-body ic-body-sky">
                            <span class="ic-val">{{ \Carbon\Carbon::parse($admin_ingreso->created_at)->format('d-m-Y') }}</span>
                        </div>
                    </td>

                    <!-- Ingresa a -->
                    <td style="width:{{ $admin_ingreso->motivo == 'COMPRA' ? '26%' : '52%' }}">
                        <div class="ic-head ic-solar">
                            <span class="ic-dot dot-solar"></span>
                            <span class="ic-lbl">Ingresa a</span>
                        </div>
                        <div class="ic-body ic-body-solar">
                            <span class="ic-val">{{ $admin_ingreso->almacen->name }}</span>
                        </div>
                    </td>
                    ...
                    <td style="width:26%">
                        ...
                        <div class="ic-body ic-body-sky">
                            <span class="ic-val">{{ $admin_ingreso->codigo_ocompra }}</span>
                        </div>
                    </td>
                    @endif
                </tr>
        ...
        <div class="section">
            ...
            <div class="resp-banner">
                ...
                <span class="resp-value">{{ $admin_ingreso->registrado_por }}</span>
            </div>
        </div>
            ...
            <table class="tabla-detalle">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="tfoot-val">{{ number_format($admin_ingreso->total ?? 0, 2, '.', ',') }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
        ...
        <div class="obs-outer no-page-break">
            ...
            <div class="obs-body">
                {{ $admin_ingreso->descripcion ? $admin_ingreso->descripcion : 'Sin observaciones.' }}
            </div>
        </div>
            ...
            <table class="footer-tbl">
                <tr>
                    <td class="footer-td-left">
                        ...
                        <span class="footer-sub">Movimiento de Ingreso &nbsp;·&nbsp; {{ $admin_ingreso->codigo }}</span>
                    </td>
