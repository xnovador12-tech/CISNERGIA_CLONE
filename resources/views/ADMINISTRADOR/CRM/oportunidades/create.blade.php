                            ...
                            <div class="row g-3">
                                    ...
                                    <select class="form-select form-select-sm select2_bootstrap w-100" id="sel_servicio_especifico" name="servicio_id" data-placeholder="Seleccionar servicio...">
                                        ...
                                        @foreach($servicios as $s)
                                            <option value="{{ $s->id }}"
                                                ...
                                                {{ $s->name }}
                                                <span class="text-muted">({{ $s->tipo_servicio === 'publico' ? 'Público' : 'Privado' }})</span>
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-12" id="wrap_descripcion_servicio">
                                    ...
                                    <textarea class="form-control form-control-sm" id="textarea_descripcion_servicio" name="descripcion_servicio" rows="2"
                                              placeholder="Se autocompletará al seleccionar el servicio...">{{ old('descripcion_servicio') }}</textarea>
                            ...
                            <div id="campos_visita" class="row g-3 mt-1" style="display: none;">
                                <div class="col-md-4">
                                    ...
                                    <input type="datetime-local" class="form-control form-control-sm" name="fecha_visita_programada"
                                           value="{{ old('fecha_visita_programada') }}" id="fecha_visita_programada">
                                </div>
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="ubicacion_visita"
                                           value="{{ old('ubicacion_visita') }}" placeholder="Ej: Av. Los Incas 456, Surco, Lima"
                                           id="ubicacion_visita">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select form-select-sm select2_bootstrap w-100" name="tecnico_visita_id"
                                        ...
                                        @foreach($vendedores ?? [] as $v)
                                            <option value="{{ $v->id }}" {{ old('tecnico_visita_id') == $v->id ? 'selected' : '' }}>
...
$(document).ready(function() {
    ...
    const serviciosDB = @json($servicios);   // lista plana de servicios   // { tipo: [{id, name, descripcion}, ...] }
    var wishlistData = [];
    var contadorItems = 0;
    ...
    var tipoOld = '{{ old('tipo_oportunidad', 'producto') }}';
