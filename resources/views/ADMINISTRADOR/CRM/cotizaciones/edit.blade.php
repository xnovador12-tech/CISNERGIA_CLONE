                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" name="fecha_vigencia" class="form-control form-control-sm @error('fecha_vigencia') is-invalid @enderror"
                                ...
                                <div class="col-md-3" id="wrap-tiempo-ejecucion"
                                     @if(!in_array($cotizacion->oportunidad?->tipo_oportunidad, ['servicio', 'mixto'])) style="display:none;" @endif>
                                    <label class="form-label">Tiempo Ejecución</label>
                                    <div class="input-group input-group-sm">
                                        <input type="number" name="tiempo_ejecucion_dias" class="form-control"
                                               value="{{ old('tiempo_ejecucion_dias', $cotizacion->tiempo_ejecucion_dias) }}" min="1">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <textarea name="condiciones_comerciales" class="form-control form-control-sm" rows="2"
                                              placeholder="Condiciones de pago, plazos de entrega, etc.">{{ old('condiciones_comerciales', $cotizacion->condiciones_comerciales) }}</textarea>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="garantia_servicio" class="form-control form-control-sm"
                                           value="{{ old('garantia_servicio', $cotizacion->garantia_servicio) }}" placeholder="Ej: 2 años en mano de obra">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Observaciones</label>
                                    <textarea name="observaciones" class="form-control form-control-sm" rows="1">{{ old('observaciones', $cotizacion->observaciones) }}</textarea>
                                </div>
                                <div class="col-12">
                                    <label class="form-label">Notas Internas <small class="text-muted">(solo visibles para el equipo)</small></label>
                                    <textarea name="notas_internas" class="form-control form-control-sm" rows="2">{{ old('notas_internas', $cotizacion->notas_internas) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="number" step="0.01" name="descuento_porcentaje" id="descuento_porcentaje"
                                           class="form-control form-control-sm" value="{{ old('descuento_porcentaje', $cotizacion->descuento_porcentaje) }}" min="0" max="50">
...
$(document).ready(function() {
    ...
    // ==================== ÍTEMS EXISTENTES ====================
    const itemsExistentes = @json($itemsParaEditar);
