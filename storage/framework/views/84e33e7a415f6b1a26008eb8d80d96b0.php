<form method="POST" action="<?php echo e(route('admin-marcas.store')); ?>" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate>      
    <?php echo csrf_field(); ?>    
...
</script><?php /**PATH C:\Users\CESHERPIPO\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/PRINCIPAL/configuraciones/marcas/create.blade.php ENDPATH**/ ?>