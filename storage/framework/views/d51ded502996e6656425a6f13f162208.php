                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="mb-0 fw-bold text-warning"><?php echo e($stats['suspendidos'] ?? 0); ?></h3>
                            </div>
                        ...
                        <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td class="fw-normal text-center align-middle">
                                    <span class="fw-semibold"><?php echo e($cliente->codigo); ?></span>
                                    <br><small class="text-muted"><?php echo e($cliente->created_at->format('d/m/Y')); ?></small>
                                </td>
