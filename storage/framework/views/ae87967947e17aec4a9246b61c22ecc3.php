<div class="modal fade" id="showaccesorio<?php echo e($al_accesorio->id_producto); ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-8 col-lg-10 d-flex">
                        <div class="align-self-center">
                            <p class="text-uppercase small mb-0"><?php echo e($al_accesorio->producto); ?> - <?php echo e($al_accesorio->umedida); ?></p>
                            ...
                            <p class="float-start text-uppercase small">Stock: <span class="float-end badge bg-primary ms-2"><?php echo e($al_accesorio->cantidad); ?></span></p>
                        </div>
                    </div>
                </div>
...
</div><?php /**PATH C:\Users\CESHER\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/ALMACEN/inventarios/show_dtlleaccesorios.blade.php ENDPATH**/ ?>