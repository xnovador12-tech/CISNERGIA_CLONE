    ...
    <div class="offcanvas offcanvas-start sidebar-nav" tabindex="-1" id="offcanvasmenu">
                    ...
                    <div class="">
                        ...
                        <li class="mx-2 my-1">
                            <a href="<?php echo e(route('admin-dashboard.index')); ?>"
                                class="nav-link px-3 <?php echo e(request()->is(['admin-dashboard*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
                        ...
                        <li class="mx-2 my-1">
                            <a href="<?php echo e(route('admin-reportes.index')); ?>"
                                class="nav-link px-3 menu <?php echo e(request()->is(['admin-reportes*']) ? 'active-item' : null); ?>">
                                <span class="fw-bold">
                        ...
                        <li class="mx-2 my-1">
                            <a href="<?php echo e(route('admin-pedidos.index')); ?>"
                                class="nav-link px-3 <?php echo e(request()->is(['admin-pedidos*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
                        ...
                        <li class="mx-2 my-1">
                            <a href="<?php echo e(route('admin-ventas.index')); ?>"
                                class="nav-link px-3 <?php echo e(request()->is(['admin-ventas*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
                        ...
                        <li class="mx-2 my-1">
                            <a href="<?php echo e(route('admin-operaciones-asignaciones.index')); ?>"
                                class="nav-link px-3 <?php echo e(request()->is(['admin-operaciones-asignaciones*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
                        ...
                        <li class="mx-2 my-1">
                            <a href="<?php echo e(route('admin-operaciones-calidad.index')); ?>"
                                class="nav-link px-3 <?php echo e(request()->is(['admin-operaciones-calidad*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
                        ...
                        <li class="mx-2 my-1">
                            <a href="<?php echo e(route('admin-operaciones-campanias.index')); ?>"
                                class="nav-link px-3 <?php echo e(request()->is(['admin-operaciones-campanias*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
                        ...
                        <li class="mx-2 my-1">
                            <a href="<?php echo e(route('admin-ordencompras.index')); ?>"
                                class="nav-link px-3 <?php echo e(request()->is(['admin-ordencompras*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
                        ...
                        <li class="mx-2 my-1">
                            <a href="<?php echo e(route('admin-ingresos.index')); ?>"
                                class="nav-link px-3 <?php echo e(request()->is(['admin-ingresos*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
                        ...
                        <li class="mx-2 my-1">
                            <a href="<?php echo e(route('admin-salidas.index')); ?>"
                                class="nav-link px-3 <?php echo e(request()->is(['admin-salidas*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
                        ...
                        <li class="mx-2 my-1">
                            <a href=""
                                class="nav-link px-3 <?php echo e(request()->is(['admin-reservas*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
                                    <i class="bi bi-calendar-check me-2"></i>
                                </span>
                                <span>
                        ...
                        <li class="mx-2 my-1">
                            <a href=""
                                class="nav-link px-3 <?php echo e(request()->is(['admin-caja*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
                        ...
                        <li class="mx-2 my-1">
                            <a href=""
                                class="nav-link px-3 <?php echo e(request()->is(['admin-cobros*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
                                    <i class="bi bi-cart me-2"></i>
                                </span>
                                <span>
                        ...
                        <li class="mx-2 my-1">
                            <a href=""
                                class="nav-link px-3 <?php echo e(request()->is(['admin-pagos*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
                                    <i class="bi bi-cash-coin me-2"></i>
                                </span>
                                <span>
                        ...
                        <li class="mx-2 my-1">
                            <a href=""
                                class="nav-link px-3 <?php echo e(request()->is(['admin-comprobantes*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
                        ...
                        <li class="mx-2 my-1">
                            <a href=""
                                class="nav-link px-3 <?php echo e(request()->is(['admin-contacto*']) ? 'active-item' : null); ?> menu">
                                <span class="fw-bold">
        ...
        <div class="offcanvas-footer border-top">
            <div class="text-white py-2">
                <p class="mb-0" style="font-size: 12px" align="center">Copyright © <?php echo date('Y'); ?> <a
    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="alert alert-danger alert-dismissible fade show d-flex align-items-center gap-2" role="alert" data-aos="fade-down">
                ...
                <div><?php echo e(session('sin_permiso')); ?></div>
...
<?php /**PATH C:\Users\ADMIN\Documents\GitHub\project_cisnergia\resources\views/TEMPLATES/administrador.blade.php ENDPATH**/ ?>