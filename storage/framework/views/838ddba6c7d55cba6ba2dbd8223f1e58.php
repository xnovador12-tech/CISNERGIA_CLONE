...
<div class="container-fluid">
    <form action="<?php echo e(isset($pedido) ? route('admin-pedidos.update', $pedido) : route('admin-pedidos.store')); ?>" method="POST" id="formPedido">
        <?php echo csrf_field(); ?>
        <?php if(isset($pedido)): ?> <?php echo method_field('PUT'); ?> <?php endif; ?>
        <div class="row g-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                    ...
                                    <select name="cliente_id" id="cliente_id" class="form-select select2-basic" required>
                                        ...
                                        <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($cliente->id); ?>" <?php echo e((isset($pedido) && $pedido->cliente_id == $cliente->id) || old('cliente_id') == $cliente->id ? 'selected' : ''); ?>>
                                                <?php echo e($cliente->nombre_completo); ?> - <?php echo e($cliente->documento); ?>
                             ...
                             <div class="col-md-4">
                                 ...
                                 <input type="text" class="form-control form-control-sm bg-light" value="<?php echo e(isset($pedido) ? $pedido->created_at->format('d/m/Y') : date('d/m/Y')); ?>" readonly>
                             ...
                             <div class="col-md-2">
                                 ...
                                 <select name="vigencia_dias" class="form-select form-select-sm" required>
                                     <option value="15" <?php echo e((isset($pedido) && $pedido->vigencia_dias == 15) || old('vigencia_dias') == 15 || !isset($pedido) ? 'selected' : ''); ?>>15 días</option>
                                     <option value="30" <?php echo e((isset($pedido) && $pedido->vigencia_dias == 30) || old('vigencia_dias') == 30 ? 'selected' : ''); ?>>30 días</option>
                                 </select>
                             </div>
                            ...
                            <input type="hidden" name="tipo" value="producto">
                             ...
                             <div class="col-md-6">
                                 ...
                                 <input type="text" name="direccion_instalacion" class="form-control form-control-sm" value="<?php echo e(isset($pedido) ? $pedido->direccion_instalacion : old('direccion_instalacion')); ?>" placeholder="Calle, Av, Lote...">
                             </div>
                             ...
                             <div class="col-md-12">
                                 ...
                                 <textarea name="observaciones" class="form-control form-control-sm" rows="2" placeholder="Ej: Entregar guías selladas, llamar a puerta, etc."><?php echo e(isset($pedido) ? $pedido->observaciones : old('observaciones')); ?></textarea>
                             </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-4 borde-top-secondary shadow-sm sticky-top" style="border-radius: 20px; top: 80px;" data-aos="fade-up">
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch p-3 bg-light rounded-3 mb-4 d-flex align-items-center shadow-sm">
                            <input class="form-check-input ms-0 me-3 mt-0" type="checkbox" role="switch" name="incluye_igv" id="incluye_igv" style="transform: scale(1.3);" value="1" <?php echo e(old('incluye_igv', isset($pedido) ? $pedido->incluye_igv : true) ? 'checked' : ''); ?>>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="<?php echo e(route('admin-pedidos.index')); ?>" class="btn btn-outline-secondary fw-bold border-0">
                                Volver al Listado
                            </a>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    const edicionItems = <?php echo json_encode(isset($pedido) ? $pedido->detalles : [], 15, 512) ?>;
    ...
    $('#formNuevoCliente').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route("admin-clientes.store")); ?>',
            method: 'POST',
            data: formData,
