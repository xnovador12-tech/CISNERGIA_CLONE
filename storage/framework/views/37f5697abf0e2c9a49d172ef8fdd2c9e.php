                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="text-center" style="font-size: 13px">
                                            ...
                                            <span class="text-uppercase"><?php echo e(Auth::user()->persona->name.' '.Auth::user()->persona->surnames); ?></span>
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" required name="motivo" id="motivo_id" required>
                                        ...
                                        <?php $__currentLoopData = $motivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $motivo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($motivo->id == '1'): ?>
                                                <option value="<?php echo e($motivo->name); ?>"><?php echo e($motivo->name); ?></option>
                                            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>  
                            ...
                            <div class="col-12 col-md-6 col-lg-3" id="concepto_div">
                                ...
                                <select class="form-select form-select-sm <?php $__errorArgs = ['Concepto_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required name="concepto" id="Concepto_id" required>
                                    <option value="<?php echo e(old('concepto')); ?>" selected="selected" hidden="hidden"><?php echo e(old('concepto')); ?></option>
...
unset($__errorArgs, $__bag); ?>  
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-select-sm <?php $__errorArgs = ['ingreso_a'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required id="ingresoa_id">
                                        <option value="<?php echo e(old('ingreso_a')); ?>" selected="selected" hidden="hidden"><?php echo e(old('ingreso_a')); ?></option>
                                        <?php $__currentLoopData = $almacen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $almacenes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($almacenes->name.' | '.$almacenes->sede->name); ?>_<?php echo e($almacenes->id); ?>_<?php echo e($almacenes->clasificacion); ?>"><?php echo e($almacenes->name.' | '.$almacenes->sede->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <input type="text" name="ingreso_a"  hidden id="ingreso_a_id">
                                    <input type="text" name="id_almacen"  hidden id="id_almacen_id">
                                    <?php $__errorArgs = ['ingreso_a'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="col-12 col-md-3 col-lg-2" id="ocompra_div">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-select-sm select2" name="ocompra" id="ocompra_id" style="width: 100%">
                                        <option value="<?php echo e(old('ocompra')); ?>" selected="selected" hidden="hidden"><?php echo e(old('ocompra')); ?></option>
                                        <?php $__currentLoopData = $ocompra; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ocompras): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($ocompras->codigo); ?>"><?php echo e($ocompras->codigo); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php $__errorArgs = ['ocompra'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="p-3 text-end" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                    <a href="<?php echo e(url('admin-ingresos')); ?>" class="btn btn-outline-secondary">Cancelar</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('TEMPLATES.administrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\CESHERPIPO\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/ALMACEN/ingresos/create.blade.php ENDPATH**/ ?>