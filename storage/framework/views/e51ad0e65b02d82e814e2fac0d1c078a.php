...
?>
<div class="modal fade" id="showaccesorios<?php echo e($sede->id); ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-secondary text-white py-2">
                <span class="modal-title text-uppercase small" id="staticBackdropLabel">Almacén de accesorios - Sede <?php echo e(Auth::user()->persona->sede?Auth::user()->persona->sede->name:'General'); ?></span>
            ...
            <div class="modal-body">
                ...
                <table id="" class="display table table-hover table-sm py-2" cellspacing="0" style="width:100%">
                    ...
                    <tbody id="inventario_table">
                        <?php $__currentLoopData = $al_accesorios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $al_accesorio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <tr class="">
                                ...
                                <td class="fw-normal align-middle text-uppercase small"><?php echo e($al_accesorio->producto); ?></td>
                                <td class="fw-normal align-middle"><?php echo e($al_accesorio->umedida); ?></td>
                                <td class="fw-normal align-middle">
                                    <?php if($al_accesorio->cantidad <= 10): ?>
                                        <span class="badge w-100 bg-danger"><?php echo e($al_accesorio->cantidad); ?></span>
                                    <?php elseif($al_accesorio->cantidad <= 20): ?>
                                        <span class="badge w-100 bg-warning"><?php echo e($al_accesorio->cantidad); ?></span>
                                    <?php elseif($al_accesorio->cantidad >= 21): ?>
                                        <span class="badge w-100 bg-success"><?php echo e($al_accesorio->cantidad); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="fw-normal align-middle text-center"><button type="button" data-bs-toggle="modal" onclick="accesoriosdetalle(this,<?php echo e($sede->id); ?>,<?php echo e($al_accesorio->id_producto); ?>)" data-bs-target="#showaccesorio<?php echo e($al_accesorio->id_producto); ?>"  class="btn btn-sm btn-secondary"><i class="bi bi-eye-fill text-white"></i></button></td>
                            </tr>
                        <?php
                            $contador++;
                        ?>  
...
<?php $__currentLoopData = $al_accesorios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $al_accesorio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php echo $__env->make('ADMINISTRADOR.ALMACEN.inventarios.show_dtlleaccesorios', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\Users\CESHER\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/ALMACEN/inventarios/showaccesorios.blade.php ENDPATH**/ ?>