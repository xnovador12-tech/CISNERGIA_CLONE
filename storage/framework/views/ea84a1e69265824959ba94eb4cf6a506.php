...
<!-- fin encabezado -->
                                            ...
                                            <div class="card-body">
                                                <div class="clearfix text-uppercase fw-bold">
                                                    <span class="float-start">
                                                        <button class="stretched-link text-uppercase text-dark fw-bold bg-transparent border-0 p-0 m-0" onclick="accesorio(<?php echo e($sede->id); ?>)" data-bs-toggle="modal" data-bs-target="#showaccesorios<?php echo e($almacenes_accesorios->id_producto); ?>" data-id="areaalmacen" >Accesorios</button>
                                                    </span>
    ...
    <?php $__currentLoopData = $sedes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sede): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php echo $__env->make('ADMINISTRADOR.ALMACEN.inventarios.show_dtlleaccesorios', ['sede_id' => $sede->id], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('ADMINISTRADOR.ALMACEN.inventarios.show_dtllerepuesto', ['sede_id' => $sede->id], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('ADMINISTRADOR.ALMACEN.inventarios.show_dtllemodulo_solar', ['sede_id' => $sede->id], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('TEMPLATES.administrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\CESHERPIPO\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/ALMACEN/inventarios/index.blade.php ENDPATH**/ ?>