    ...
    <div class="container-fluid">
        <div class="row g-4">
            <div class="col-lg-8">
                ...
                <?php if($oportunidad->servicio_id || $oportunidad->requiere_visita_tecnica): ?>
                <div class="card border-4 borde-top-secondary shadow-sm mb-4" style="border-radius: 20px" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <?php if($oportunidad->servicio): ?>
                            <div class="col-md-6">
                                <div class="bg-success bg-opacity-10 rounded p-3">
                                    <p class="mb-1 small text-muted"><i class="bi bi-wrench me-1"></i>Servicio</p>
                                    <p class="mb-0 fw-bold"><?php echo e($oportunidad->servicio->name); ?></p>
                                    <span class="badge bg-<?php echo e($oportunidad->servicio->tipo_servicio === 'publico' ? 'primary' : 'secondary'); ?> bg-opacity-25 text-<?php echo e($oportunidad->servicio->tipo_servicio === 'publico' ? 'primary' : 'secondary'); ?> mt-1">
                                        <?php echo e($oportunidad->servicio->tipo_servicio === 'publico' ? 'Servicio Público' : 'Servicio Privado'); ?>

                                    </span>
                                    <?php if($oportunidad->descripcion_servicio): ?>
                                        <p class="mb-0 mt-2 small text-muted"><?php echo e($oportunidad->descripcion_servicio); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <?php endif; ?>
                                    ...
                                    <div class="row g-2">
                                        <div class="col-md-4">
                                            ...
                                            <p class="mb-0 fw-bold">
                                                <?php echo e($oportunidad->fecha_visita_programada?->format('d/m/Y H:i') ?? 'Por definir'); ?>

                                            </p>
                                        </div>
                                        <?php if($oportunidad->ubicacion_visita): ?>
                                        <div class="col-md-5">
                                            <small class="text-muted d-block">Ubicación</small>
                                            <p class="mb-0"><?php echo e($oportunidad->ubicacion_visita); ?></p>
                                        </div>
                                        <?php endif; ?>
                                        <?php if($oportunidad->tecnicoVisita): ?>
                                        <div class="col-md-3">
                                            <small class="text-muted d-block">Técnico Asignado</small>
                                            <p class="mb-0 fw-bold">
                                                <?php echo e($oportunidad->tecnicoVisita->persona?->name ?? $oportunidad->tecnicoVisita->email); ?>

                                                <?php echo e($oportunidad->tecnicoVisita->persona?->surnames ?? ''); ?>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <p class="mb-0 text-success fw-bold"><?php echo e($oportunidad->resultado_visita); ?></p>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-4 borde-top-secondary shadow-sm mb-4" style="border-radius: 20px" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="card-body text-center">
                        <?php if($oportunidad->monto_final): ?>
                            ...
                            <h2 class="text-success fw-bold mb-0">S/ <?php echo e(number_format($oportunidad->monto_final, 0)); ?></h2>
                            <small class="text-muted d-block mb-3">Monto real (cotización aceptada)</small>
                            <small class="text-muted">Estimación inicial: S/ <?php echo e(number_format($oportunidad->monto_estimado, 0)); ?></small>
                        <?php else: ?>
                        ...
                        ?>
                        <p class="mb-0"><strong>Valor Ponderado:</strong> S/ <?php echo e(number_format($montoBase * $oportunidad->probabilidad / 100, 0)); ?></p>
                    </div>
                </div>
                ...
                <div class="card border-4 borde-top-secondary shadow-sm mb-4" style="border-radius: 20px" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <?php elseif($esPropuesta || $yaEnPropuesta): ?>
                                
                                <form action="<?php echo e(route('admin.crm.oportunidades.crear-cotizacion', $oportunidad)); ?>" method="POST" id="form-cotizacion">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="btn btn-primary btn-sm w-100">
                                        <i class="bi bi-file-earmark-plus me-2"></i>
                                        <?php echo e($tieneCotizaciones ? 'Nueva Cotización' : 'Crear Cotización'); ?>

                                    </button>
                                </form>
                                <?php if($tieneCotizaciones): ?>
                                <small class="text-muted text-center d-block">
                                    <i class="bi bi-info-circle me-1"></i>Ya tiene <?php echo e($oportunidad->cotizaciones->count()); ?> cotización(es)
                                </small>
                                <?php endif; ?>
                            <?php else: ?>
                ...
                <div class="card border-4 shadow-sm mb-4" style="border-radius: 20px; border-top: 4px solid #198754 !important;" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="card-body">
                        <?php $cotizacionAceptada = $oportunidad->cotizaciones->where('estado','aceptada')->first(); ?>
                        <?php if($cotizacionAceptada): ?>
                            <div class="mb-2">
                                <small class="text-muted">Cotización aprobada</small>
                                <p class="mb-0 fw-bold"><?php echo e($cotizacionAceptada->codigo); ?></p>
                            </div>
                        <?php endif; ?>
                        <?php if($oportunidad->cliente): ?>
                            <div class="alert alert-success mb-0 py-2">
                                <i class="bi bi-person-check me-2"></i><strong>Cliente:</strong> <?php echo e($oportunidad->cliente->codigo); ?>
