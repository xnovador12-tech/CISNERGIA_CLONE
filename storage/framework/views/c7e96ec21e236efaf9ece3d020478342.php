...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12 col-md-3 col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="cantidad_total" id="cantidad_total_id" class="form-control form-control-sm <?php $__errorArgs = ['cantidad_total'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('TEMPLATES.administrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\CESHERPIPO\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/PRINCIPAL/configuraciones/kits/create.blade.php ENDPATH**/ ?>