                    ...
                    <div class="row g-2">
                        <div class="col-12 col-md-4 col-lg-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select form-select-sm <?php $__errorArgs = ['proveedor_id'];
...
unset($__errorArgs, $__bag); ?> select2_bootstrap_bootstrap" required id="proveedor_id" >
                                    <option disabled="disabled" selected="selected" hidden="hidden"><?php echo e(old('proveedor_id')); ?></option>
                                    <?php $__currentLoopData = $proveedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proveedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($proveedor->id); ?>"><?php echo e('RS: '.$proveedor->name_contacto.' || PN: '.$proveedor->persona->name); ?></option>
                        ...
                        <div class="col-12 col-md-4 col-lg-2">
                            <div class="mb-3">
                                ...
                                <input type="text" disabled class="form-control form-control-sm bg-white" id="fecha_actual" name="fecha_actual" value="<?php echo e($fecha_actual); ?>" readonly>
                                <input type="hidden" name="fecha_actual" value="<?php echo e(old('fecha_actual', $fecha_actual)); ?>">
                            </div>
                        </div>
                        <div class="col-12 col-md-4 col-lg-2">
                            <div class="mb-3">
...
unset($__errorArgs, $__bag); ?> 
            ...
            <div class="p-3 text-end" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                <a href="<?php echo e(url('admin-ordenes-compras')); ?>" class="btn btn-outline-secondary">Cancelar</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('TEMPLATES.administrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\CESHERPIPO\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/COMPRAS/ocompras/create.blade.php ENDPATH**/ ?>