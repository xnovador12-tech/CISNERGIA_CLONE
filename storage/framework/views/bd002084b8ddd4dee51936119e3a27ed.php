                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $admin_ordencompras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin_ordencompra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="fw-normal text-center align-middle"><span class="badge bg-warning border-0"><?php echo e($admin_ordencompra->estado_proceso); ?></span></td>
                                <td class="fw-normal text-center align-middle"><span class="badge bg-warning border-0"><?php echo e($admin_ordencompra->estado_pago); ?></span></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('TEMPLATES.administrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\CESHERPIPO\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/compras/ocompras/index.blade.php ENDPATH**/ ?>