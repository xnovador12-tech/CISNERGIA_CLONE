                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td class="text-center"><span class="badge bg-light text-dark"><?php echo e($ticket->categoria_label); ?></span></td>
                                        ...
                                        <div class="dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end shadow">
                                                ...
                                                <?php if(!in_array($ticket->estado, ['resuelto', 'cerrado'])): ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <li>
                                                        <form action="<?php echo e(route('admin.crm.tickets.escalar', $ticket)); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
