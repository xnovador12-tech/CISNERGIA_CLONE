<form method="POST" action="<?php echo e(route('admin-servicios.update', $admin_servicio->slug)); ?>" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate>      
    <?php echo csrf_field(); ?>  
    <?php echo method_field('put'); ?>  
    <div class="modal fade" id="editservicios<?php echo e($admin_servicio->slug); ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($admin_servicio->name); ?>" required maxLength="100">  
...
unset($__errorArgs, $__bag); ?>" name="descripcion" placeholder="Escribe una descripción" style="height: 150px"><?php echo e($admin_servicio->descripcion); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="estado" id="estado_id" class="form-select text-uppercase" required>
                                    <option value="<?php echo e($admin_servicio->estado); ?>" selected="selected" hidden="hidden"><?php echo e($admin_servicio->estado); ?></option>
...
</script><?php /**PATH C:\Users\CESHER\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/PRINCIPAL/configuraciones/servicios/edit.blade.php ENDPATH**/ ?>