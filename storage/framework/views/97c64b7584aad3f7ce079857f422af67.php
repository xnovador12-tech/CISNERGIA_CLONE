            ...
            <div class="card-body">
                ...
                <table id="tablaCotizaciones" class="table table-hover align-middle" cellspacing="0" style="width:100%">
                    <thead class="bg-dark text-white border-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $cotizaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $cotizacione): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                    $estadoColors = [
                                        'borrador' => 'secondary', 
                                        'enviada' => 'primary', 
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <strong><?php echo e($cotizacione->codigo); ?></strong>
                                        <br><small class="text-muted"><?php echo e($cotizacione->created_at->format('d/m/Y')); ?></small>
                                        <?php if($cotizacione->version > 1): ?>
                                            <br><span class="badge bg-info">v<?php echo e($cotizacione->version); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="text-start">
                                        <?php if($cotizacione->oportunidad): ?>
                                            <strong><?php echo e(Str::limit($cotizacione->oportunidad->nombre, 30)); ?></strong>
                                            <?php if($cotizacione->oportunidad->prospecto): ?>
                                                <br><small class="text-muted"><?php echo e(Str::limit($cotizacione->oportunidad->prospecto->nombre_completo, 30)); ?></small>
                                            <?php endif; ?>
                                        <?php else: ?>
                                    ...
                                    <td class="text-center">
                                        <span class="badge bg-info"><?php echo e(number_format($cotizacione->potencia_kw ?? 0, 1)); ?> kW</span>
                                    </td>
                                    <td class="text-center"><?php echo e(number_format($cotizacione->produccion_anual_kwh ?? 0, 0)); ?> kWh</td>
                                    <td class="text-center text-success fw-bold">S/ <?php echo e(number_format($cotizacione->ahorro_anual_soles ?? 0, 0)); ?></td>
                                    <td class="text-center text-primary fw-bold">S/ <?php echo e(number_format($cotizacione->total ?? 0, 0)); ?></td>
                                    <td class="text-center">
                                        <span class="badge bg-<?php echo e($estadoColors[$cotizacione->estado] ?? 'secondary'); ?>">
                                            <?php echo e(ucfirst(str_replace('_', ' ', $cotizacione->estado))); ?>

                                        </span>
                                        <?php if($cotizacione->fecha_vigencia && $cotizacione->fecha_vigencia->isPast() && !in_array($cotizacione->estado, ['aceptada', 'rechazada', 'vencida'])): ?>
                                    ...
                                    <td class="text-center">
                                        <div class="dropstart">
                                            ...
                                            <ul class="dropdown-menu shadow">
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('admin.crm.cotizaciones.show', $cotizacione)); ?>">
                                                        <i class="bi bi-eye text-info me-2"></i>Ver Detalles
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('admin.crm.cotizaciones.pdf', $cotizacione)); ?>">
                                                        <i class="bi bi-file-pdf text-danger me-2"></i>Descargar PDF
                                                    </a>
                                                </li>
                                                <?php if(!in_array($cotizacione->estado, ['aceptada', 'rechazada'])): ?>
                                                    <li>
                                                        <a class="dropdown-item" href="<?php echo e(route('admin.crm.cotizaciones.edit', $cotizacione)); ?>">
                                                            <i class="bi bi-pencil text-secondary me-2"></i>Editar
                                                        </a>
                                                    </li>
                                                <?php endif; ?>
                                                <?php if($cotizacione->estado === 'borrador'): ?>
                                                    <li><hr class="dropdown-divider"></li>
                                                    <li>
                                                        <form action="<?php echo e(route('admin.crm.cotizaciones.enviar', $cotizacione)); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if($cotizacione->estado === 'enviada'): ?>
                                                    <li><hr class="dropdown-divider"></li>
                                                    <li>
                                                        <form action="<?php echo e(route('admin.crm.cotizaciones.aprobar', $cotizacione)); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
                                                    ...
                                                    <li>
                                                        <button type="button" class="dropdown-item text-danger" 
                                                                onclick="rechazarCotizacion('<?php echo e($cotizacione->slug); ?>')">
...
function rechazarCotizacion(slug) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.method = 'POST';
            form.action = '<?php echo e(route("admin.crm.cotizaciones.index")); ?>/' + slug + '/rechazar';
...
<?php echo $__env->make('TEMPLATES.administrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/PRINCIPAL/crm/cotizaciones/index.blade.php ENDPATH**/ ?>