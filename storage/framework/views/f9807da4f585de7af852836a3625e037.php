...
<!-- fin encabezado -->
    ...
    <form method="POST" action="/admin-kits/<?php echo e($admin_kit->slug); ?>" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate>      
        <?php echo csrf_field(); ?>  
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-3 col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value="<?php echo e($admin_kit->codigo); ?>" class="form-control form-control-sm bg-white" disabled id="codigo_id">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12 col-md-2 col-lg-2">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="precio_total" value="<?php echo e(old('precio_total', $admin_kit->precio_total)); ?>" class="form-control form-control-sm <?php $__errorArgs = ['precio_total'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($admin_kit->cantidad_total); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('cantidad_total', $admin_kit->cantidad_total)); ?>" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-switch">
                                                <select class="js-example-basic-multiple form-select form-select-sm select2" name="etiquetas[]" multiple="multiple" style="width:100%">
                                                    ...
                                                    <option <?php if($admin_kit->etiquetas->contains($etiqueta->id)): ?> selected <?php endif; ?> value="<?php echo e($etiqueta->id); ?>"><?php echo e($etiqueta->name); ?></option>
...
unset($__errorArgs, $__bag); ?>" name="descripcion" id="editor" placeholder="Escribe una descripción" style="height: 210px"><?php echo e(old('descripcion', $admin_kit->descripcion)); ?></textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="card imagecardfiles" style="min-height: 200px">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row my-3">
                                                    <?php $__currentLoopData = $admin_kit->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('TEMPLATES.administrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\CESHER\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/PRINCIPAL/configuraciones/kits/edit.blade.php ENDPATH**/ ?>