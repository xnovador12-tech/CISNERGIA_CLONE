                        ...
                        <?php $__currentLoopData = $admin_kits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin_kit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="fw-normal text-center align-middle">S/
                                    <?php echo e(number_format($admin_kit->precio, 2)); ?></td>
                                ...
                                <td class="align-middle">                                        
                                    <div class="dropstart">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow">   
                                            <li>
                                                <a href="<?php echo e(url("/admin-kits/$admin_kit->slug")); ?>" class="dropdown-item d-flex align-items-center"><i class="bi bi-eye text-secondary me-2"></i>Detalles</a>
                                            </li>
...
<?php echo $__env->make('TEMPLATES.administrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\CESHERPIPO\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/PRINCIPAL/configuraciones/kits/index.blade.php ENDPATH**/ ?>