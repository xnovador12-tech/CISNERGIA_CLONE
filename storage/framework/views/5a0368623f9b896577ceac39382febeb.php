                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="mb-0 fw-bold text-warning"><?php echo e($estadisticas['ciclo_promedio'] ?? 0); ?> días</h3>
                            </div>
        ...
        <div class="card border-4 borde-top-secondary shadow-sm" style="border-radius: 20px; min-height: 500px" data-aos="fade-up">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="incluir-cerradas" 
                                   ...
                                   onchange="window.location.href='<?php echo e(route('admin.crm.oportunidades.index')); ?>' + (this.checked ? '?incluir_cerradas=1' : '')">
                ...
                <table id="tablaOportunidades" class="table table-hover align-middle" style="width:100%">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $oportunidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $oportunidad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge bg-info"><?php echo e(number_format($oportunidad->potencia_kw ?? 0, 1)); ?> kW</span>
                                </td>
                                <td class="text-center fw-bold text-primary">
                                    S/ <?php echo e(number_format($oportunidad->monto_estimado, 0)); ?>
                                ...
                                <td class="text-center">
                                    <div class="dropstart">
                                        ...
                                        <ul class="dropdown-menu shadow">
                                            <li><a class="dropdown-item" href="<?php echo e(route('admin.crm.oportunidades.show', $oportunidad->slug)); ?>">
                                                <i class="bi bi-eye text-info me-2"></i>Ver Detalles</a></li>
                                            <li><a class="dropdown-item" href="<?php echo e(route('admin.crm.oportunidades.edit', $oportunidad->slug)); ?>">
                                                <i class="bi bi-pencil text-secondary me-2"></i>Editar</a></li>
                                            <?php if(!in_array($oportunidad->etapa, ['ganada', 'perdida'])): ?>
                                                <li><hr class="dropdown-divider"></li>
                                                <li>
                                                    <form action="<?php echo e(route('admin.crm.oportunidades.crear-cotizacion', $oportunidad->slug)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                                ...
                                                <li>
                                                    <form action="<?php echo e(route('admin.crm.oportunidades.ganada', $oportunidad->slug)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                                ...
                                                <li>
                                                    <form action="<?php echo e(route('admin.crm.oportunidades.perdida', $oportunidad->slug)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('TEMPLATES.administrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/PRINCIPAL/crm/oportunidades/index.blade.php ENDPATH**/ ?>