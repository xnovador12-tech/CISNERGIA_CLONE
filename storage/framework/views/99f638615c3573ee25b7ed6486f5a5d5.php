                    ...
                    <div class="card-body pb-0">
                        ...
                        <ul class="list-unstyled">
                            <li class="text-primary menu_item">
                                ...
                                <a href="<?php echo e(route('admin-informacion.index')); ?>" class="link-primary text-decoration-none">Información</a>
                            </li>
                            <li class="text-primary menu_item">
                                <i class="bi bi-award me-2"></i>
                                <a href="<?php echo e(route('admin-roles.index')); ?>" class="link-primary text-decoration-none">Roles</a>
                            </li>
                            <li class="text-primary menu_item">
                                <i class="bi bi-people me-2"></i>
                                <a href="<?php echo e(route('admin-usuarios.index')); ?>" class="link-primary text-decoration-none">Usuarios</a>
                            </li>
                            <li class="text-primary menu_item">
                                <i class="bi bi-person-badge me-2"></i>
                                <a href="<?php echo e(route('admin-perfil.index')); ?>" class="link-primary text-decoration-none">Mi perfil</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="card-body pb-0">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="text-primary menu_item">
                                ...
                                <a href="<?php echo e(route('admin-categorias.index')); ?>" class="link-primary text-decoration-none">Categorías</a>
                            </li>
                            
                            <li class="text-primary menu_item">
                                <i class="bi bi-tags me-2"></i>
                                <a href="<?php echo e(route('admin-marcas.index')); ?>" class="link-primary text-decoration-none">Marcas</a>
                            </li>
                            <li class="text-primary menu_item">
                                <i class="bi bi-bookmarks me-2"></i>
                                <a href="<?php echo e(route('admin-etiquetas.index')); ?>" class="link-primary text-decoration-none">Etiquetas</a>
                            </li>
                    ...
                    <div class="card-body pb-0">
                        ...
                        <ul class="list-unstyled">
                            <li class="text-primary menu_item">
                                ...
                                <a href="<?php echo e(route('admin-proveedores.index')); ?>" class="link-primary text-decoration-none">Proveedores</a>
                            </li>
                    
                            <li class="text-primary menu_item">
                                <i class="bi bi-boxes me-2"></i>
                                <a href="<?php echo e(route('admin-productos.index')); ?>" class="link-primary text-decoration-none">Productos</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="card-body pb-0">
                        ...
                        <ul class="list-unstyled">
                            <li class="text-primary menu_item">
                                ...
                                <a href="<?php echo e(route('admin-clientes.index')); ?>" class="link-primary text-decoration-none">Clientes</a>
                            </li>
                            <li class="text-primary menu_item">
                            ...
                            <li class="text-primary menu_item">
                                ...
                                <a href="<?php echo e(route('admin-descuentos.index')); ?>" class="link-primary text-decoration-none">Descuento</a>
                            </li>
                            <li class="text-primary menu_item">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <ul class="list-unstyled">
                            <li class="text-primary menu_item">
                                ...
                                <a href="<?php echo e(route('admin-kits.index')); ?>" class="link-primary text-decoration-none">Kits</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('TEMPLATES.administrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\CESHERPIPO\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/PRINCIPAL/configuraciones/index.blade.php ENDPATH**/ ?>