                                        ...
                                        <div class="dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end shadow">
                                                ...
                                                <?php if($mantenimiento->estado === 'programado'): ?>
                                                    ...
                                                    <li><form action="<?php echo e(route('admin.crm.mantenimientos.confirmar', $mantenimiento)); ?>" method="POST"><?php echo csrf_field(); ?><button class="dropdown-item text-primary"><i class="bi bi-check me-2"></i>Confirmar</button></form></li>
                                                <?php endif; ?>
                                                <?php if(in_array($mantenimiento->estado, ['confirmado', 'en_camino'])): ?>
                                                    <li><form action="<?php echo e(route('admin.crm.mantenimientos.iniciar', $mantenimiento)); ?>" method="POST"><?php echo csrf_field(); ?><button class="dropdown-item text-warning"><i class="bi bi-play-circle me-2"></i>Iniciar</button></form></li>
                                                <?php endif; ?>
                                                ...
                                                <?php if(!in_array($mantenimiento->estado, ['completado', 'cancelado'])): ?>
                                                    <li><hr class="dropdown-divider"></li>
                                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.crm.mantenimientos.reporte', $mantenimiento)); ?>"><i class="bi bi-file-pdf text-danger me-2"></i>Generar Reporte</a></li>
                                                <?php endif; ?>
                                            </ul>
                                        </div>
                                    </td>
        ...
        <div class="modal fade" id="modalCompletar-<?php echo e($mantenimiento->id); ?>" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form action="<?php echo e(route('admin.crm.mantenimientos.completar', $mantenimiento)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="modal-header">
                            <h5 class="modal-title"><i class="bi bi-check-circle me-2"></i>Completar Mantenimiento - <?php echo e($mantenimiento->codigo); ?></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                            <div class="alert alert-info mb-3">
                                <small>
                                    <strong>Cliente:</strong> <?php echo e($mantenimiento->cliente->nombre ?? 'N/A'); ?><br>
                                    <strong>Tipo:</strong> <?php echo e(ucfirst($mantenimiento->tipo)); ?><br>
                                    <strong>Fecha Programada:</strong> <?php echo e($mantenimiento->fecha_programada->format('d/m/Y')); ?>

                                </small>
                            </div>
                            <div class="row g-3">
                                <div class="col-12">
                                    <label for="trabajo_realizado_<?php echo e($mantenimiento->id); ?>" class="form-label fw-bold">Trabajo Realizado <span class="text-danger">*</span></label>
                                    <textarea name="trabajo_realizado" id="trabajo_realizado_<?php echo e($mantenimiento->id); ?>" class="form-control" rows="3" placeholder="Describa el trabajo realizado..." required></textarea>
                                </div>
                                <div class="col-md-6">
                                    <label for="hallazgos_<?php echo e($mantenimiento->id); ?>" class="form-label fw-bold">Hallazgos</label>
                                    <textarea name="hallazgos" id="hallazgos_<?php echo e($mantenimiento->id); ?>" class="form-control" rows="2" placeholder="Hallazgos encontrados..."></textarea>
                                </div>
                                <div class="col-md-6">
                                    <label for="recomendaciones_<?php echo e($mantenimiento->id); ?>" class="form-label fw-bold">Recomendaciones</label>
                                    <textarea name="recomendaciones" id="recomendaciones_<?php echo e($mantenimiento->id); ?>" class="form-control" rows="2" placeholder="Recomendaciones para el cliente..."></textarea>
                                </div>
                                <div class="col-md-6">
                                    <label for="costo_mano_obra_<?php echo e($mantenimiento->id); ?>" class="form-label fw-bold">Costo Mano de Obra (S/.)</label>
                                    <input type="number" name="costo_mano_obra" id="costo_mano_obra_<?php echo e($mantenimiento->id); ?>" class="form-control" step="0.01" min="0" value="0">
                                </div>
                                <div class="col-md-6">
                                    <label for="costo_materiales_<?php echo e($mantenimiento->id); ?>" class="form-label fw-bold">Costo Materiales (S/.)</label>
                                    <input type="number" name="costo_materiales" id="costo_materiales_<?php echo e($mantenimiento->id); ?>" class="form-control" step="0.01" min="0" value="0">
                                </div>
                                <div class="col-12">
                                    <label for="observaciones_<?php echo e($mantenimiento->id); ?>" class="form-label fw-bold">Observaciones</label>
                                    <textarea name="observaciones" id="observaciones_<?php echo e($mantenimiento->id); ?>" class="form-control" rows="2" placeholder="Observaciones adicionales..."></textarea>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('TEMPLATES.administrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/PRINCIPAL/crm/mantenimientos/index.blade.php ENDPATH**/ ?>