...
<!-- fin encabezado -->
        ...
        <form class="form-group" method="POST" action="<?php echo e(route('admin-ordenservicios.update', $admin_ordenservicio->slug)); ?>" enctype="multipart/form-data" autocomplete="off">      
            <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-3">
                                        <div class="text-center" style="font-size: 13px">
                                            ...
                                            <span class="text-uppercase"><?php echo e($admin_ordenservicio->codigo); ?></span>
                                            <input type="text" name="codigo" id="servicio_codigo" value="<?php echo e($admin_ordenservicio->codigo); ?>" hidden>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-3" style="font-size: 13px">
                                        <div class="text-center">
                                            ...
                                            <span class="text-uppercase"><?php echo e($admin_ordenservicio->fecha); ?></span>
                                            <input hidden name="fecha" value="<?php echo e($admin_ordenservicio->fecha); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>" required name="motivo" id="motivo_id" >
                                        <option value="<?php echo e($admin_ordenservicio->motivo); ?>" selected="selected"><?php echo e($admin_ordenservicio->motivo); ?></option>
...
unset($__errorArgs, $__bag); ?>" required name="formapago" id="forma_pago_id" >
                                        <option value="<?php echo e($admin_ordenservicio->formapago); ?>" selected="selected"><?php echo e($admin_ordenservicio->formapago); ?></option>
...
unset($__errorArgs, $__bag); ?>" name="plazo_pago" required id="plazo_pago_id" >
                                        <option value="<?php echo e($admin_ordenservicio->plazo_pago); ?>" selected="selected" hidden="hidden"><?php echo e($admin_ordenservicio->plazo_pago); ?></option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12 col-md-3 col-lg-2">
                                <div class="mb-3 mb-lg-0">
                                    ...
                                    <input class="form-control form-control-sm" type="text" id="codigo_venta_id" value="<?php echo e($admin_ordenservicio->codigo_venta); ?>" disabled>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row justify-content-beetween">
                            <div class="col-12 col-md-6">
                                <textarea name="nota" id="" class="form-control w-100" placeholder="Observaciones" rows="3"><?php echo e(old('nota', $admin_ordenservicio->nota)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="p-3 text-end" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                    <a href="<?php echo e(url('admin-ordenservicios')); ?>" class="btn btn-outline-secondary">Cancelar</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('TEMPLATES.administrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\CESHER\Documents\GitHub\project_cisnergia\resources\views/ADMINISTRADOR/compras/oservicios/edit.blade.php ENDPATH**/ ?>